                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-row">
                                ...
                                <div class="ml-2 align-self-center">
                                    <h3 class="mb-0 font-weight-light">23</h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-row">
                                ...
                                <div class="ml-2 align-self-center">
                                    <h3 class="mb-0 font-weight-light">23</h3>
                                    <h5 class="text-muted mb-0">Product Stock</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-row">
                                ...
                                <div class="ml-2 align-self-center">
                                    <h3 class="mb-0 font-weight-light">95</h3>
                                    <h5 class="text-muted mb-0">User Details</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-row">
                                ...
                                <div class="ml-2 align-self-center">
                                    <h3 class="mb-0 font-weight-light">87</h3>
                                    <h5 class="text-muted mb-0">Ordered Product</h5>
                                </div>
                            </div>
                        </div>
                    </div>
